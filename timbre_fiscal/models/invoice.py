...
class TimbreFiscal(models.Model):
    ...
    timbre = fields.Monetary(string='Timbre', store=True, readonly=True, compute='_compute_amount')
    timbre_signed = fields.Monetary(string='Timbre', store=True, readonly=True, compute='_compute_amount')
    ...
    def _compute_amount(self):
        for move in self:
            ...
            for tm in move.invoice_line_ids:
                if tm.product_id.timbre_fiscal:
                    timbre = 0.60
                    total_tax = total_tax + timbre
                    total_tax_currency = total_tax_currency + timbre
